...
<div id="header" align="center" margin="25px">
  ...
  <div id="badges" marginBottom="25px">
    <h3>Muhammed Suwaneh | <span><b>Software Engineer</b></span></h3>
        Results-oriented & experienced C# .NET Software Engineer | Specializing in WPF, Unity, and ASP.NET for kiosk systems, touch screens, digital information displays and web applications. Passionate about creating seamless user experiences and staying ahead in tech trends. 
  </div>
